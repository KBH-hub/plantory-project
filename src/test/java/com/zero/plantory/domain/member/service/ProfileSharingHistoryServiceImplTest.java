...
class ProfileSharingHistoryServiceImplTest {
    ...
    @InjectMocks
    private ProfileSharingHistoryServiceImpl mySharingHistoryService;
    ...
    void getMySharingHistoryListTest() {
        ...
        List<ProfileSharingHistoryListResponse> result = mySharingHistoryService.getMySharingHistoryList(request);
